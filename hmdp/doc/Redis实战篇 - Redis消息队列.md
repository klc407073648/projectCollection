...
![](./images/msg-queue/Message_Queue.png)
...
![](./images/msg-queue/pubsub消息队列.png)
...
![](./images/msg-queue/stream_1.png)

例如：

![](./images/msg-queue/stream_2.png)

读取消息的方式之一：XREAD

![](./images/msg-queue/stream_3.png)

例如，使用XREAD读取第一个消息：

![](./images/msg-queue/stream_4.png)

XREAD阻塞方式，读取最新的消息：

![](./images/msg-queue/stream_5.png)
