...
![优惠券](./images/voucher-seckill/代金券.png)
...
![全局唯一ID](./images/voucher-seckill/全局唯一ID.png)

为了增加ID的安全性，我们可以不直接使用Redis自增的数值，而是拼接一些其它信息：

![](./images/voucher-seckill/拼接信息.png)
...
![](./images/voucher-seckill/优惠券下单.png)
...
![](./images/voucher-seckill/秒杀下单.png)
...
![](./images/voucher-seckill/秒杀下单逻辑.png)
...
![](./images/voucher-seckill/超卖问题.png)
...
![](./images/voucher-seckill/版本号法.png)

CAS法：

![](./images/voucher-seckill/CAS法.png)
...
![](./images/voucher-seckill/一人一单.png)
...
![](./images/voucher-seckill/两份服务启动.png)
...
![](./images/voucher-seckill/并发安全问题.png)
