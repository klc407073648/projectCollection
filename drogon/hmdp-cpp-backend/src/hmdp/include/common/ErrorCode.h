...
public:
    ...
    static ErrorCode DB_ERROR()
    {
        return ErrorCode(50001, "数据库异常", "");
    }

    static ErrorCode CACHE_ERROR()
    {
        return ErrorCode(50100, "缓存异常", "");
    }

    static ErrorCode INTER_SERVER_ERROR()
    {
        return ErrorCode(60100, "服务内部错误", "");
    }

    static ErrorCode GLOBAL_ERROR()
    {
        return ErrorCode(60200, "全局错误", "");
    }
