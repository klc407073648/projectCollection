...
const std::string RedisConstants::LOCK_ORDER_KEY = "lock:order:";
...
const std::string RedisConstants::ORIGIN_DATA_KEY = "OriginData";
const std::string RedisConstants::REDIS_DATA_EXPIRETIME_KEY = "ExpireTime";